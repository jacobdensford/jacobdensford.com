...
A player character starts with a name, a style, a motivation, and a flaw. (A class will be chosen later.)
...
Roll or choose an equipment package from your class.
...
Then roll or choose one of these hundred trinkets.

1d100|Trinkets
:--|---
1|Etc

> Equipment doesn't add dice to rolls but it sometimes can modify roll results. It can also have rolls of its own, such as for damage from a weapon or damage reduction from a shield.
...
:--|---
1|Nothing
2-3|Gain a new d4 skill
4-6|Increase a skill's die
7-8|Etc
9-10|Gain a new class feature
11-12|Etc
