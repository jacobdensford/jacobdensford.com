...
> - having rescued the innocent, gain 200 XP per soul saved.
> - after defeating monsters and overcoming traps, gain one tenth their listed XP.
>
> *When using this alternate option, humans gain a 10% boost to XP gained.*
...
*These rules modify Lifting and Carrying (PH, 176) and uses parts of Variant: Encumbrance (PH, 176).*
...
*This rule modifies Dark Vision (PH, 183)*

### Resting

A character may spend one hit die after each hour of rest during a short or long rest to recover hit points. Hit dice spent during a long rest rest automatically restore their maximum amount of hit points.
...
*This rule modifies Critical Hits (PH, 196).*
...
*This rule modifies Components (PH, 203)*
